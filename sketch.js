...
function preload(){
  ...
  sheepImg = loadAnimation("assets/sheep-removebg-preview.png","assets/sheep2-removebg-preview.png","assets/sheep3-removebg-preview.png");
  sheepimage = loadImage("assets/sheep3-removebg-preview.png")
...
if(sheepGroup.isTouching(bulletGroup)){
  for(var i=0;i<sheepGroup.length;i++){     
      
   if(sheepGroup[i].isTouching(bulletGroup)){
        sheepGroup[i].destroy()
...
if(sheepGroup.isTouching(player)){
 ...
 for(var i=0;i<sheepGroup.length;i++){     
  ...
  if(sheepGroup[i].isTouching(player)){
       sheepGroup[i].destroy()
...
function enemy(){
  if(frameCount%50===0){
    ...
    sheep = createSprite(random(500,1100),random(500,700),40,40)
   // sheep.addImage(sheepimage)
   sheep.addAnimation("sheep",sheepImg)
    sheep.scale = 1
    sheep.velocityX = -3
   // sheep.debug= true
    //sheep.setCollider("rectangle",0,0,400,400)
